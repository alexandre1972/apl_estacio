<%@ Page Title="Log In" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="EstacioCob.Account.Login" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        Favor inserir usuário e senha.
        <asp:HyperLink ID="RegisterHyperLink" runat="server" EnableViewState="false">Registrar</asp:HyperLink> se você não tiver uma conta.
    </p>
                ...
                <fieldset class="login">
                    ...
                    <p>
                        ...
                        <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName" 
                             CssClass="failureNotification" ErrorMessage="Nome do usuário e obrigatório." ToolTip="Nome do usuário e obrigatório." 
